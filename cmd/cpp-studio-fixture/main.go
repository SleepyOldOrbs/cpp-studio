...
func printUsage(w io.Writer) {
	...
	fmt.Fprintln(w, "  cpp-studio-fixture speech --text <text> --out <path> [--instruct <direction>] [--voice-ref <wav> --reference-text <text>]")
...
func runSpeech(args []string, stdout, stderr io.Writer) error {
	...
	flags.String("instruct", "", "fixture/test helper Character Voice direction")
