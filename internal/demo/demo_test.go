...
func TestHandlerServesIndex(t *testing.T) {
	...
	for _, marker := range []string{
		...
		`id="extractPlayButton"`,
		`aria-pressed="false" disabled>Play audio</button>`,
...
func TestHandlerServesAssets(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "javascript play pause toggles",
			path:        "/app.js",
			contentType: "javascript",
			needle:      "bindAudioToggleButton",
		},
		{
			name:        "javascript extractor pause resume",
			path:        "/app.js",
			contentType: "javascript",
			needle:      "extractPausePlayback",
		},
		{
			name:        "javascript transcript segment playback",
			path:        "/app.js",
			contentType: "javascript",
			needle:      "extract-segment-play",
		},
		{
			name:        "javascript deduplicated diarization status",
			path:        "/app.js",
			contentType: "javascript",
			needle:      `name === "diarize-sherpa" ? "diarize"`,
		},
		{
			name:        "javascript comprehensive clear all",
			path:        "/app.js",
			contentType: "javascript",
			needle:      "window.location.reload()",
		},
		{
			name:        "css single-line engine rack",
			path:        "/styles.css",
			contentType: "text/css",
			needle:      "flex-wrap: nowrap",
		},
		{
			name:        "css equal voice cloning columns",
			path:        "/styles.css",
			contentType: "text/css",
